          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-lg font-bold" style={{ color: '#2baae2' }}>
                  MISW4411
                </span>
              </div>
              <motion.button
            ...
            <div className="p-6">
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-700">
                  <MessageSquare className="w-5 h-5" style={{ color: '#2baae2' }} />
                  <span className="font-medium">Chat Principal</span>
                </div>
                
                <div className="flex items-center space-x-3 text-gray-700">
                  <Settings className="w-5 h-5" style={{ color: '#2baae2' }} />
                  <span className="font-medium">Configuración</span>
                </div>
                
                <div className="flex items-center space-x-3 text-gray-700">
                  <HelpCircle className="w-5 h-5" style={{ color: '#2baae2' }} />
